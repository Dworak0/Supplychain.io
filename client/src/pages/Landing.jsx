...
const FloatingShape = ({ delay, duration, style, children }) => (
    <motion.div
        animate={{
            y: [0, -25, 0],
            rotate: [0, 8, -4, 0],
    ...
    return (
        <div style={{ minHeight: '100vh', paddingTop: '70px' }}>
            ...
            <section style={{
                ...
                <FloatingShape delay={0} duration={6} style={{ top: '20%', left: '15%' }}>
                ...
                <FloatingShape delay={1.5} duration={7} style={{ top: '35%', right: '18%' }}>
                ...
                <FloatingShape delay={0.8} duration={5} style={{ bottom: '25%', left: '22%' }}>
                ...
                <FloatingShape delay={2.5} duration={8} style={{ bottom: '15%', right: '28%' }}>
